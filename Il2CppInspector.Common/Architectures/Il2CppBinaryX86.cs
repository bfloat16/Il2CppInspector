...
namespace Il2CppInspector
{
    ...
    {
        public Il2CppBinaryX86(IFileFormatStream stream, EventHandler<string> statusCallback = null)
        ...
        protected override (ulong, ulong) ConsiderCode(IFileFormatStream image, uint loc)
        {
            ...
            if (image is IElfReader elf)
            {
                ...
                bytes = [0x55, 0x89, 0xE5, 0x53, 0x83, 0xE4, 0xF0, 0x83, 0xEC, 0x20, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x5B];
                image.Position = loc;
