...
public struct GenericParameterIndex(int value) : IIndexType<GenericParameterIndex>, IReadable, IEquatable<GenericParameterIndex>
{
    ...
    public static int Size(in StructVersion version = default, in ReaderConfig config = default) => IIndexType<GenericParameterIndex>.IndexSize(version, config);
    ...
    public static bool operator ==(GenericParameterIndex left, GenericParameterIndex right) => left._value == right._value;

    public static bool operator !=(GenericParameterIndex left, GenericParameterIndex right) => !(left == right);

    public override readonly bool Equals(object obj) => obj is GenericParameterIndex other && Equals(other);

    public readonly bool Equals(GenericParameterIndex other) => this == other;
