...
public struct DefaultValueDataIndex(int value) : IIndexType<DefaultValueDataIndex>, IReadable, IEquatable<DefaultValueDataIndex>
{
    ...
    public static int Size(in StructVersion version = default, in ReaderConfig config = default) => IIndexType<DefaultValueDataIndex>.IndexSize(version, config);
    ...
    public static bool operator ==(DefaultValueDataIndex left, DefaultValueDataIndex right) => left._value == right._value;

    public static bool operator !=(DefaultValueDataIndex left, DefaultValueDataIndex right) => !(left == right);

    public override readonly bool Equals(object obj) => obj is DefaultValueDataIndex other && Equals(other);

    public readonly bool Equals(DefaultValueDataIndex other) => this == other;
