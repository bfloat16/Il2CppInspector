...
public struct GenericContainerIndex(int value) : IIndexType<GenericContainerIndex>, IReadable, IEquatable<GenericContainerIndex>
{
    ...
    public static int Size(in StructVersion version = default, in ReaderConfig config = default) => IIndexType<GenericContainerIndex>.IndexSize(version, config);
    ...
    public static bool operator ==(GenericContainerIndex left, GenericContainerIndex right) => left._value == right._value;

    public static bool operator !=(GenericContainerIndex left, GenericContainerIndex right) => !(left == right);

    public override readonly bool Equals(object obj) => obj is GenericContainerIndex other && Equals(other);

    public readonly bool Equals(GenericContainerIndex other) => this == other;
