...
public struct TypeDefinitionIndex(int value) : IIndexType<TypeDefinitionIndex>, IReadable, IEquatable<TypeDefinitionIndex>
{
    ...
    public static int Size(in StructVersion version = default, in ReaderConfig config = default) => IIndexType<TypeDefinitionIndex>.IndexSize(version, config);
    ...
    public static bool operator ==(TypeDefinitionIndex left, TypeDefinitionIndex right) => left._value == right._value;

    public static bool operator !=(TypeDefinitionIndex left, TypeDefinitionIndex right) => !(left == right);

    public override readonly bool Equals(object obj) => obj is TypeDefinitionIndex other && Equals(other);

    public readonly bool Equals(TypeDefinitionIndex other) => this == other;
