...
namespace Il2CppInspector
{
    ...
    public class Il2CppInspector
    {
        ...
        // Shortcuts
        public StructVersion Version => Metadata.Version > Binary.Image.Version ? Metadata.Version : Binary.Image.Version;
        ...
        private List<MetadataUsage> buildLateBindingMetadataUsages()
        {
            ...
            for (uint i = 0; i < words.Length; i++)
            {
                ...
                if (metadataValue < uint.MaxValue)
                {
                    ...
                    if (CheckMetadataUsageSanity(usage) && BinaryImage.TryMapFileOffsetToVA(i * ((uint)BinaryImage.Bits / 8), out var va))
        ...
        public static List<Il2CppInspector> LoadFromStream(
            Stream binaryStream,
