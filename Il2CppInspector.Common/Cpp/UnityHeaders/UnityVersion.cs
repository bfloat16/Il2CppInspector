...
namespace Il2CppInspector.Cpp.UnityHeaders
{
    ...
    public partial class UnityVersion : IComparable<UnityVersion>, IEquatable<UnityVersion>
    {
        ...
        public static string BuildTypeToString(BuildTypeEnum buildType) =>
            buildType switch
            {
        ...
        public static BuildTypeEnum StringToBuildType(string s) =>
            s switch
            {
                "" => BuildTypeEnum.Unspecified,
        ...
        {
            return other != null && Major == other.Major && Minor == other.Minor && Update == other.Update && BuildType == other.BuildType && BuildNumber == other.BuildNumber;
        }
