...
#pragma warning disable CS0649
    ...
    public interface Ielf_phdr<TWord>
        where TWord : struct
    {
        uint p_type { get; }
    ...
    public class elf_32_phdr : Ielf_phdr<uint>
    {
        ...
        {
            get => f_p_offset;
            set => f_p_offset = value;
        }
        public uint p_filesz
        {
            get => f_p_filesz;
            set => f_p_filesz = value;
        }
        public uint p_vaddr
        {
            get => f_p_vaddr;
    ...
    public interface Ielf_sym<TWord>
        where TWord : struct
    {
        uint st_name { get; }
        TWord st_value { get; }
    ...
    public class elf_dynamic<TWord>
        where TWord : struct
    {
        public TWord d_tag;
        public TWord d_un;
