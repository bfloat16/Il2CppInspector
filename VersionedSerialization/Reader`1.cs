    ...
    where TReader : IReader, allows ref struct
{
    ...
    public string ReadString(int length = -1, Encoding? encoding = null) => _impl.ReadString(length, encoding);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ReadOnlySpan<byte> ReadBytes(long length) => _impl.ReadBytes(length);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Read<T>(scoped ref T value)
        where T : unmanaged => Read(new Span<T>(ref value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Read<T>(scoped Span<T> dest)
        where T : unmanaged => _impl.Read(dest);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void ReadPrimitive<T>(scoped ref T value)
        where T : unmanaged => ReadPrimitive(new Span<T>(ref value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void ReadPrimitive<T>(scoped Span<T> dest)
        where T : unmanaged => _impl.ReadPrimitive(dest);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public T ReadVersionedObject<T>(in StructVersion version = default)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public ulong ReadNativeUInt() => Config.Is32Bit ? ReadPrimitive<uint>() : ReadPrimitive<ulong>();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public long ReadNativeInt() => Config.Is32Bit ? ReadPrimitive<int>() : ReadPrimitive<long>();
}
